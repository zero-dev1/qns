  ...
  return (
    <section id="my-names" className="py-[100px] px-6">
      <div className="max-w-[1120px] mx-auto">
        <p className="font-satoshi font-medium text-sm text-[#00D179] uppercase tracking-[0.15em] mb-8">
          MY NAMES
        </p>
        ...
        {address && !loading && names.length === 0 && (
          <div className="text-center py-12">
            ...
            <button
              ...
              className="px-6 py-3 rounded-xl bg-[#00D179] hover:bg-[#00B868] text-white font-bold transition-colors duration-200 cursor-pointer"
            >
        ...
        {address && !loading && names.length > 0 && (
          <div className="space-y-4">
            {names.map((item) => (
              <div
                key={item.name}
                className="bg-[#141414] border border-[#1E1E1E] rounded-[12px] p-6 md:p-8"
              >
