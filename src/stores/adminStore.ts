...
const RESERVED_NAMES_LIST = [
  'aave','about','abu','adam','admin','africa','ahmed','airdrop','aisha','alaoui','alchemist','alex','ali','alice','alpha','altcoingordon','altcoinsensei','altstein','amazon','amm','analyst','anna','ansem','anthony','api','app','apple','ariff','arthurhays','artist','asia','australia','avalanche','avatar','axe','axeledger','badge','bahrain','bear','becker','ben','binance','bio','bitboy','bitcoin','bitomoney','block','blog','bluntz','bob','borrow','brazil','brian','bridge','bull','bullishbear','burn','canada','cardano','careers','ceo','cex','chad','chadpumpiano','chain','chainlink','chancellor','china','chris','cli','cobie','coinbase','compound','congress','contact','contract','crayola','creator','crediblecrypto','crypto44','cryptobanter','cryptobirb','cryptocaesar','cryptofella','cryptogideon','cryptogodjohn','cryptomanic','cryptomanran','cryptomonk','cryptonova','cryptotony','cryptowizard','cryptoyoda','ctgymrat','cto','curve','dan','dao','dapp','david','defi','degen','degenkenn','degenpoet','demo','deploy','deployer','developer','dex','dippy','discord','docs','dogecoin','donalt','drew','drprofit','druya','dtcrypto','dubai','dydx','egypt','eliz','ella','embassy','emily','emma','engineer','epoch','eric','ethereum','europe','exchange','explorer','ezmoney','farm','fatima','fattony','faucet','fee','fifa','follow','founder','france','fusion','futures','gainzy','gamer','gateway','gemdetector','genesis','germany','gideon','goodie','google','goomba','gorgonite','governance','government','governor','harvest','hassan','hawk','help','hodl','home','hongkong','hsaka','hub','hwmedia','identity','incomeshark','index','india','influencer','info','intrepid','inversebrah','investor','jack','james','jane','japan','jason','jobs','joe','john','jopp','jordan','justiinape','kaleo','karamata','kate','kenobi','kenya','kevin','kingdom','kito','korea','kraken','kuwait','labs','lambo','larkdavis','laura','lawless','layeralpha','ledger','lend','leo','leverage','lido','link','liquidity','lisa','london','lookonchain','lsd','luke','main','mainnet','maker','manage','margin','maria','mark','market','matt','matteo','max','mayor','media','meme','memechi','memecoin','meta','metamask','mexico','mezcez','mia','michael','microsoft','mike','minister','mint','mohammed','moneylord','moon','murad','musa','musician','name','nations','nebraskagooner','network','news','newyork','nft','nick','nigeria','nilsb','nite','noach','noah','node','nucleus','nucleusx','octgems','official','olivia','olympic','oman','omar','opensea','options','oracle','panamax','paul','paw','pentoshi','pepe','perps','peter','phantom','polkadot','polygon','pool','portal','potus','president','press','privacy','profile','protocol','pump','qatar','qfclash','qflink','qfpad','qfstream','quantum','quantumfusion','quantumnotary','rabby','rachel','rainbow','raoul','reddit','register','registrar','registry','rektcapital','relay','renew','researcher','resolver','reverse','reward','ripple','rishad','root','roshi','royal','rush','russia','ryan','sam','sarah','satoshi','satoshiflipper','saudi','saylor','sdk','search','senate','settings','shard','shark','sharky','shiba','sigma','singapore','singularity','soef','solana','sophie','spot','stake','status','steve','streamer','support','swampmonkey','swap','sykodelic','tang','tareeq','team','teddy','telegram','terms','tesla','test','testnet','tiktok','token','tokyo','tom','trade','trader','treasury','trezor','turkey','twitter','uae','ukraine','uniswap','united','uponlygreg','usa','validator','vault','vector','verified','vest','vitalik','wallet','watcherguru','web','web3princess','welcome','whale','yield','youtube','zhusu'
];
